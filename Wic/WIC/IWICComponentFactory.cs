...
namespace WIC
{
	[Guid("412D0C3A-9650-44FA-AF5B-DD2A06C8E8FB"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[ComImport]
	public interface IWICComponentFactory : IWICImagingFactory
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		void CreateMetadataReader([In] ref Guid guidMetadataFormat, [In] ref Guid pguidVendor, [In] uint dwOptions, [MarshalAs(UnmanagedType.Interface)] [In] IStream pIStream, [MarshalAs(UnmanagedType.Interface)] out IWICMetadataReader ppIReader);

		[MethodImpl(MethodImplOptions.InternalCall)]
		void CreateMetadataReaderFromContainer([In] ref Guid guidContainerFormat, [In] ref Guid pguidVendor, [In] uint dwOptions, [MarshalAs(UnmanagedType.Interface)] [In] IStream pIStream, [MarshalAs(UnmanagedType.Interface)] out IWICMetadataReader ppIReader);
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		void CreateMetadataWriterFromReader([MarshalAs(UnmanagedType.Interface)] [In] IWICMetadataReader pIReader, [In] ref Guid pguidVendor, [MarshalAs(UnmanagedType.Interface)] out IWICMetadataWriter ppIWriter);

		[MethodImpl(MethodImplOptions.InternalCall)]
		void CreateQueryReaderFromBlockReader([MarshalAs(UnmanagedType.Interface)] [In] IWICMetadataBlockReader pIBlockReader, [MarshalAs(UnmanagedType.Interface)] out IWICMetadataQueryReader ppIQueryReader);

		[MethodImpl(MethodImplOptions.InternalCall)]
		void CreateQueryWriterFromBlockWriter([MarshalAs(UnmanagedType.Interface)] [In] IWICMetadataBlockWriter pIBlockWriter, [MarshalAs(UnmanagedType.Interface)] out IWICMetadataQueryWriter ppIQueryWriter);
